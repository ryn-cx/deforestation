# TODO: Validate
"""Rebuilds every Deforestation model from the responses recorded under `_files`.
...
# TODO: Validate
def generate_all(client: Deforestation) -> None:
...
if __name__ == "__main__":
    ...
    generate_all(Deforestation(build_client_automatically()))
