...
class Value(GAPIBaseModel):
    ...
    href: str
    id: str | None = None
    is_currently_applied: bool = Field(..., alias='isCurrentlyApplied')
    query_token: str = Field(..., alias='queryToken')
...
class Filters(GAPIBaseModel):
    model_config = ConfigDict(extra='forbid')
    call_to_action_text: str = Field(..., alias='callToActionText')
    items: list[Item1]
    position: int
    text: str
...
class PageMetadata1(GAPIBaseModel):
    model_config = ConfigDict(extra='forbid')
...
class SwiftPageParameters(GAPIBaseModel):
    model_config = ConfigDict(extra='forbid')
    page_id: str = Field(..., alias='pageId')
    page_type: str = Field(..., alias='pageType')

class RequestFeatureSwitches(GAPIBaseModel):
    model_config = ConfigDict(extra='forbid')
...
class FeatureSwitches1(GAPIBaseModel):
    model_config = ConfigDict(extra='forbid')
